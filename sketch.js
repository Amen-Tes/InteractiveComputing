...
let canvasName;
var boids = [];
let foxsound, bearsound, lionsound, wolfsound;
let bgm;
...
class Cloud {
  constructor(x,z,size){
    ...
    this.container.addChild(this.treecomponent1);
    this.container.addChild(this.treecomponent2);
    this.container.addChild(this.treecomponent3);
    this.container.addChild(this.treecomponent4);
    this.container.addChild(this.treecomponent5);

    this.container.spinY(random(360));

    world.add(this.container);

    console.log(this.treecomponent1.getX(),this.treecomponent2.getX(),this.container.getX());
  ...
  move(){
    ...
    if (this.treecomponent1.getWorldPosition().x>350) {
